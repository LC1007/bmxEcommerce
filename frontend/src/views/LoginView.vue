            ...
            <form>
                <div class="form">
                    ...
                    <div>
                        ...
                        <input type="email" name="email" id="" placeholder="john@gmail.com">
                    </div>
                </div>
                ...
                <div class="form">
                    <div class="form-group">
                        ...
                        <div>
                            ...
                            <input type="text" name="surname" id="" placeholder="Doe">
                        </div>
                        <div>
...
<template>
    <div>
        <div class="container">
            ...
            <div class="left-side">
                <video width="100%" class="home-video" data-object-fit="cover" muted autoplay loop>
